...
export type ProblemaQualidade = Fragilidade | ProblemaPerformance | ProblemaDocumentacao | ProblemaFormatacao;
...
export interface ProblemaTeste {
    tipo: 'missing-tests' | 'poor-coverage' | 'flaky-test' | 'slow-test' | 'test-smells' | 'mock-abuse';
    descricao: string;
...
export interface ProblemaSeguranca {
    tipo: 'eval-usage' | 'dangerous-html' | 'weak-crypto' | 'unsafe-regex' | 'prototype-pollution' | 'path-traversal' | 'hardcoded-secrets' | 'unhandled-async' | 'unhandled-async-event';
    descricao: string;
    severidade: 'baixa' | 'media' | 'alta' | 'critica';
    linha: number;
    sugestao: string;
...
export {};
//# sourceMappingURL=detectores.d.ts.map