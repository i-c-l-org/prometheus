    ...
    async function listMarkdown(dir) {
        ...
        for (const entry of entries) {
            ...
            if (entry.isDirectory()) {
                if (/^(node_modules|dist|coverage|pre-public|preview-prometheus|\.git)$/i.test(entry.name))
                    continue;
...
//# sourceMappingURL=fix-md-fences.js.map