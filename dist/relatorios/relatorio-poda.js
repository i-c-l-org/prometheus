...
export async function gerarRelatorioPodaMarkdown(caminho, podados, mantidos, opcoes) {
...
export async function gerarRelatorioPodaJson(caminho, podados, mantidos) {
    const json = {
...
//# sourceMappingURL=relatorio-poda.js.map