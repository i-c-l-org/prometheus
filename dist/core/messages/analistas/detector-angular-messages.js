...
export const DetectorAngularMensagens = createI18nMessages({
    vazamentoMemoriaSubscription: (nome) => `[ALERTA] Potencial vazamento de memoria: Subscription '${nome}' detectada sem cleanup no ngOnDestroy.`,
    ...
    signalSugerido: (nome) => `[SUGESTAO] Atributo '${nome}' poderia ser um Signal para melhor performance e reatividade.`,
    ...
    vazamentoMemoriaSubscription: (nome) => `[ALERT] Potential memory leak: Subscription '${nome}' detected without cleanup in ngOnDestroy.`,
    ...
    signalSugerido: (nome) => `[SUGGESTION] Attribute '${nome}' could be a Signal for better performance and reactivity.`,
