...
export const DetectorAngularMensagens = createI18nMessages({
    vazamentoMemoriaSubscription: (nome) => `🚨 Potencial vazamento de memória: Subscription '${nome}' detectada sem cleanup aparente no ngOnDestroy.`,
    ...
    signalSugerido: (nome) => `💡 Sugestão (Angular Moderno): Atributo '${nome}' poderia ser um Signal para melhor performance e reatividade.`,
    ...
    vazamentoMemoriaSubscription: (nome) => `🚨 Potential memory leak: Subscription '${nome}' detected without apparent cleanup in ngOnDestroy.`,
    ...
    signalSugerido: (nome) => `💡 Suggestion (Modern Angular): Attribute '${nome}' could be a Signal for better performance and reactivity.`,
...
//# sourceMappingURL=detector-angular-messages.js.map