...
function streamScan({ maxCommits = 800 } = {}) {
  return new Promise((resolve, reject) => {
    ...
    child.stdout.on('data', (chunk) => {
      const processedData /* TODO: Renomear de 'data' para algo mais específico */ = leftover + chunk;
...
async function main() {
  try {
    ...
    if (total === 0) {// console.log('OK: Nenhum padrão de segredo encontrado nos últimos 800 commits.'); // TODO: Remover antes da produção
    } else {
