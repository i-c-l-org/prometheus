...
// console.log('SPDX inserido em:', relNorm); // TODO: Remover antes da produção
    changed++;
  }
  if (LIST_ONLY || CHECK_ONLY) {
    if (missing.length) {
// console.log('Arquivos sem "SPDX-License-Identifier: MIT":'); // TODO: Remover antes da produção
