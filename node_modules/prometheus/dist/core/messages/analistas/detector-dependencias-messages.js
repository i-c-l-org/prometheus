...
export const DetectorDependenciasMensagens = createI18nMessages({
    ...
    importSemExtensao: (modulo) => `Import sem extensão explícita: '${modulo}'. Considere adicionar para clareza.`,
    importHttpInseguro: (url) => `Import de URL HTTP (inseguro): '${url}'. Use HTTPS.`,
    importNaoResolvido: (modulo) => `Módulo não resolvido: '${modulo}'. Verifique installed/typos.`,
    duplicataDependencia: (nome) => `Dependência duplicada detectada: '${nome}'. Remova duplicatas.`
}, {
    ...
    importSemExtensao: (modulo) => `Import without explicit extension: '${modulo}'. Consider adding for clarity.`,
    importHttpInseguro: (url) => `Import from HTTP URL (insecure): '${url}'. Use HTTPS.`,
    importNaoResolvido: (modulo) => `Unresolved module: '${modulo}'. Check if installed/typos.`,
    duplicataDependencia: (nome) => `Duplicate dependency detected: '${nome}'. Remove duplicates.`
});
