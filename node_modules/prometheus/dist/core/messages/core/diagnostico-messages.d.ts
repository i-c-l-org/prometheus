...
export declare const MENSAGENS_GUARDIAN: {
    ...
    readonly gpg: {
        readonly habilitado: "GPG habilitado para assinatura";
        readonly desabilitado: "GPG desabilitado, usando apenas hash";
        readonly assinaturaValida: (assinante: string) => string;
        readonly assinaturaInvalida: "⚠️ Assinatura GPG inválida!";
        readonly erro: (msg: string) => string;
        readonly chaveNaoEncontrada: "Nenhuma chave GPG configurada";
        readonly instalacaoNaoEncontrada: "GPG não está instalado no sistema";
    };
    readonly status: {
