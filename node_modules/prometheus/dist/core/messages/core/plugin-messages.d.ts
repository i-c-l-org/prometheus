export declare const ReactMensagens: {
    ...
    useEffectEmptyDeps: string;
    useEffectMissingDeps: string;
    useEffectAsyncNoCleanup: string;
    reactMemoNoCompare: string;
    useStateInitializerExpensive: string;
};
export declare const ReactHooksMensagens: {
    ...
    missingMemo: string;
    missingUseCallback: string;
    staleClosure: string;
    missingKey: string;
    useEffectEmptyDeps: string;
    setStateInRender: string;
    missingReactImport: string;
};
...
export declare const CssMensagens: {
    ...
    deepNesting: string;
    nestingWithoutParentSelector: string;
};
export declare const HtmlMensagens: {
    ...
    multipleH1: string;
    missingAriaMain: string;
    missingAriaNav: string;
    missingAriaBanner: string;
    missingAriaContentinfo: string;
    missingAriaComplementary: string;
    formLabelMissing: string;
    inputAutocompleteMissing: string;
};
