...
export const MENSAGENS_EXECUTOR = createI18nMessages({
    ...
    analiseRapidaConcluida: (total, duracao) => `✅ Análise rápida concluída: ${total} arquivos em ${duracao}`,
    tecnicaGlobalSucesso: (nome) => `Técnica global "${nome}"`,
    tecnicaGlobalErro: (nome, erro) => `❌ Erro na técnica global '${nome}': ${erro}`,
    tecnicaGlobalTimeout: (nome) => `⏰ Timeout: analista global '${nome}' excedeu o tempo limite`,
    tecnicaGlobalTimeoutOcorrencia: (nome, timeout) => `Timeout na técnica global '${nome}': ${timeout}ms excedido`,
    tecnicaGlobalErroOcorrencia: (nome, erro) => `Falha na técnica global '${nome}': ${erro}`,
    tecnicaLocalErro: (nome, arquivo, erro) => `❌ Erro em '${nome}' para ${arquivo}: ${erro}`,
    tecnicaLocalTimeoutOcorrencia: (nome, arquivo, timeout) => `Timeout na técnica '${nome}' para ${arquivo}: ${timeout}ms excedido`,
    tecnicaLocalErroOcorrencia: (nome, arquivo, erro) => `Falha na técnica '${nome}' para ${arquivo}: ${erro}`,
    ...
    falhaPersistirMetricas: (erro) => `Falha ao persistir histórico de métricas: ${erro}`
}, {
    ...
    analiseRapidaConcluida: (total, duracao) => `✅ Fast analysis concluded: ${total} files in ${duracao}`,
    tecnicaGlobalSucesso: (nome) => `Global technique "${nome}"`,
    tecnicaGlobalErro: (nome, erro) => `❌ Error in global technique '${nome}': ${erro}`,
    ...
    tecnicaLocalErro: (nome, arquivo, erro) => `❌ Error in '${nome}' for ${arquivo}: ${erro}`,
