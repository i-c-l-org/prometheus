...
export const CliComandoReestruturarMensagens = createI18nMessages({
    ...
    erroDuranteReestruturacao: (erroMensagem) => `❌ Error during restructuring: ${erroMensagem}`,
    ...
    planoSugeridoFast: (origem, moverLen) => `✅ Suggested plan (${origem}) FAST: ${moverLen} move(s)`,
    dryRunFast: 'Dry-run requested (--plan-only). (FAST MODE)',
    reestruturacaoConcluidaFast: (moverLen) => `✅ Restructuring completed: ${moverLen} moves. (FAST MODE)`,
    ...
    spinnerPlanoSugerido: (origem, moverLen) => `Suggested plan (${origem}): ${moverLen} move(s)`,
    spinnerConflitosDetectados: (qtd) => `Conflicts detected: ${qtd}`,
    ...
    fallbackProblemasEstruturais: (qtd) => `🔧 Restructuring based on ${qtd} structural problems found:`,
    ...
    reestruturacaoConcluida: (total, frase) => `✅ Restructuring completed: ${total} ${frase}.`,
    ...
    erroDuranteReestruturacao: (erroMensagem) => `❌ Erro durante a reestruturação: ${erroMensagem}`,
    ...
    planoSugeridoFast: (origem, moverLen) => `✅ Plano sugerido (${origem}) FAST: ${moverLen} movimentação(ões)`,
    dryRunFast: 'Dry-run solicitado (--somente-plano). (FAST MODE)',
    reestruturacaoConcluidaFast: (moverLen) => `✅ Reestruturação concluída: ${moverLen} movimentos. (FAST MODE)`,
    ...
    fallbackProblemasEstruturais: (qtd) => `🔧 Reestruturando baseado em ${qtd} problemas estruturais encontrados:`,
    fallbackLinhaOcorrencia: (tipo, arq, msg) => `  [${tipo}] ${arq}: ${msg}`,
    ...
    reestruturacaoConcluida: (total, frase) => `✅ Reestruturação concluída: ${total} ${frase}.`,
