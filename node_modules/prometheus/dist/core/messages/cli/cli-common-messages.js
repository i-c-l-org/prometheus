...
export const CliCommonMensagens = createI18nMessages({
    ...
    erros: {
        falhaFlags: (erro) => `Falha ao aplicar flags: ${erro}`,
        argumentoInvalido: (arg) => `Argumento inválido: ${arg}`
    },
    confirmacao: {
    ...
    erros: {
        falhaFlags: (erro) => `Failed to apply flags: ${erro}`,
        argumentoInvalido: (arg) => `Invalid argument: ${arg}`
    },
    confirmacao: {
...
//# sourceMappingURL=cli-common-messages.js.map