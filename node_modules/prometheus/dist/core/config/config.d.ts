...
export declare const configPadrao: {
    ...
    GUARDIAN_GPG_ENABLED: boolean;
    GUARDIAN_GPG_KEY_ID: string;
    GUARDIAN_GPG_PASSPHRASE: string;
    ...
    ANALISE_LIMITES: {
        ...
        SEGURANCA: {
            MAX_HARDCODED_SECRETS: number;
            MAX_EVAL_USAGE: number;
            MAX_INNERHTML: number;
            MAX_WEAK_CRYPTO: number;
            MAX_UNSAFE_REGEX: number;
            MAX_PATH_TRAVERSAL: number;
            MAX_SQL_INJECTION: number;
            MAX_COMMAND_INJECTION: number;
            MAX_UNHANDLED_ASYNC: number;
            MAX_IGNORAR_TESTES: boolean;
        };
        PERFORMANCE: {
            MAX_LOOPS_ANNIDED: number;
            MAX_BLOCKING_OPS: number;
            MAX_MEMORY_LEAKS: number;
            MAX_N_PLUS_ONE: number;
            MAX_INEFFICIENT_SPREAD: number;
            MAX_LARGE_BUNDLE: number;
            MAX_CONSOLE_LOG: number;
            MAX_IGNORAR_TESTES: boolean;
        };
        COMPLEXIDADE: {
            MAX_CYCLOMATIC: number;
            MAX_LINHAS_ARQUIVO: number;
            MAX_IMPORTS: number;
            MAX_EXPORTS: number;
        };
        TESTES: {
            MAX_DESCRIBE_VAZIO: number;
            MAX_IT_SEM_espera: number;
            MIN_ASSERTIONS: number;
        };
        REACT: {
            MAX_USE_EFFECT_DEPS: number;
            MAX_RENDER_PERMANENT: number;
            MAX_INLINE_STYLE: number;
        };
    };
