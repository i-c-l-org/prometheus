...
export interface ProblemaSeguranca {
    tipo: 'eval-usage' | 'dangerous-html' | 'weak-crypto' | 'unsafe-regex' | 'prototype-pollution' | 'path-traversal' | 'hardcoded-secrets' | 'unhandled-async' | 'unhandled-async-event' | 'sql-injection' | 'command-injection' | 'xxe' | 'insecure-deserialization' | 'catastrophic-regex' | 'weak-random' | 'insecure-cookie' | 'missing-csrf' | 'hardcoded-ip' | 'jwt-weak' | 'tar-pit' | 'bypass-security' | 'ssrf' | 'xss-avancado' | 'open-redirect';
    descricao: string;
    severidade: 'baixa' | 'media' | 'alta' | 'critica';
    linha: number;
    coluna?: number;
