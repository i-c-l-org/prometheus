...
import { analistaAngular } from '@analistas/detectores/detector-angular.js';
...
import { analistaEstiloModerno } from '@analistas/detectores/detector-estilo-moderno.js';
...
comSupressaoInline(analistaConstrucoesSintaticas), comSupressaoInline(analistaCodigoFragil), comSupressaoInline(analistaDuplicacoes), comSupressaoInline(analistaAngular as unknown as Analista),
